        ...
        if ($statement = $con->prepare($query)) {
            if ($statement->bind_param("sisisisi", $medicineName, $dosageQty, $dosageUnit, $milligramQty, $milligramUnit, $frequencyQty, $frequencyUnit, $medicine_id)) {
                ...
                if ($statement->execute()) {
                    ...
                    echo '<h3 class="text-center text-success">Successfully Updated <a href="index.php">View All Medicine</a> </h3>';
                    $row = [];
                    
                } else {
                    header("location: edit_drug.php?id=" . $medicine_id. "");
                    echo '<h3 class="text-center text-danger">Error Updating Medicine</h3>';
...
<?php include_page_header("Edit Medicine") ?>
<div class="container">
    <div class="row mt-4">
        <div class="col-md-5">
            <h5 class="display-5 my-1">Edit Medicine</h5>
            <?php
            if (!empty($row)) {
                echo '
                    ...
                    <input type="submit" name="btn_update_medicine" value="Update Medicine" class="form-control btn btn-warning btn-block my-3">
                </form>';
            }
